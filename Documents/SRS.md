...
К внешним критериям относятся удобный поиск и получение всей необъодимой информации о товаре.

##### 3.2.1. Внутренние критерии <a name="internalCriteria"> </a>
Внутренними критериями являются быстрый отклик приложения и динамический поиск с получением результата без перезагрузки сраницы.
